<template>
  <v-card>
    ...
    <div class="card-thumbnail-wrapper">
        <progressiveimage class="card-thumbnail" :src="'https://assets.malcoded.com/v1/48238e83-87dd-4b4f-be48-26ea7c89e8e7/'+post.thumbnail" />
    </div>
    ...
    <a icon target="_blank" class="share-link" v-on:click="socialClick('twitter')" :href="'http://twitter.com/share?url=https://malcoded.com/posts/'+post.url+'&text='+post.title+'&via=malcoded&hashtags=angular,javascript'">
    ...
    <a target="_blank" class="share-link" v-on:click="socialClick('facebook')" :href="'http://www.facebook.com/sharer/sharer.php?u=https://malcoded.com/posts/'+post.url">
        <v-btn icon class="icon-color">
    ...
    <a target="_blank" class="share-link" v-on:click="socialClick('reddit')" :href="'http://reddit.com/submit?url=https://malcoded.com/posts/'+post.url+'&title='+post.title">
        <v-btn icon class="icon-color">
