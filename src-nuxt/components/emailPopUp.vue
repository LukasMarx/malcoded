      ...
      <v-layout row wrap>
        <v-flex lg6 md6 xs12 style="padding-right: 64px">
          ...
          <div class="point">
            ...
            >Stay up to date about what is going on in the web-dev community and on this site.</p>
          </div>
          <div class="point">
            <v-avatar color="#eee" class="icon">
              <svg
            ...
            <p
              class="description-text"
            >Get notified about special offers of our own, or our partners' products. Don't worry, we won't spam your inbox!</p>
          </div>
        </v-flex>
        <v-flex lg6 md6 xs12 style="display:flex">
          <v-form ref="form" v-model="valid" class="form" lazy-validation>
            ...
            <p class="small-print">
              ...
              <a
                href="/privacy"
                v-bind:style="{'color': color || '#c40030'}"
              >Privacy Policy</a>
            </p>
