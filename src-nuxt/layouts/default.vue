...
@font-face {
  ...
  src: local('Roboto Light'), local('Roboto-Light'), url('/fonts/roboto-v18-latin-300.eot?#iefix') format('embedded-opentype'),
    /* IE6-IE8 */ url('/fonts/roboto-v18-latin-300.woff2') format('woff2'), /* Super Modern Browsers */ url('/fonts/roboto-v18-latin-300.woff') format('woff'),
...
@font-face {
  ...
  src: local('Roboto Medium'), local('Roboto-Medium'), url('/fonts/roboto-v18-latin-500.eot?#iefix') format('embedded-opentype'),
    /* IE6-IE8 */ url('/fonts/roboto-v18-latin-500.woff2') format('woff2'), /* Super Modern Browsers */ url('/fonts/roboto-v18-latin-500.woff') format('woff'),
...
@font-face {
  ...
  src: local('Roboto Bold'), local('Roboto-Bold'), url('/fonts/roboto-v18-latin-700.eot?#iefix') format('embedded-opentype'),
    /* IE6-IE8 */ url('/fonts/roboto-v18-latin-700.woff2') format('woff2'), /* Super Modern Browsers */ url('/fonts/roboto-v18-latin-700.woff') format('woff'),
